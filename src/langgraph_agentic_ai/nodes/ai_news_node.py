...
class AINewsNode:
    ...
    def fetch_news(self, state: dict)-> dict:
        ...
        Returns:
            dict: Updated state with 'news_data' key containing fetched data        
        """
    ...
    def summarize_news(self, state: dict)->dict:
        """
        Summarize the fetched AI News data
        
        Args:
            state (dict): The state dictionary containing 'news_data'

        Returns:
            dict: Updated state with 'summary' key containing fetched data        
        """
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            ("system", """Summarize AI News articles into markdown format. For each item include:
             ...
             - Sort the news Date wise (latest first)
             - Source URLs as link
             Use Format:
             ### [Date]
             - [Summary](URL)"""),
